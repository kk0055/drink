              ...
              <nav class="nav">
                  <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                      ...
                      @auth
                          ...
                          <li>
                              <a class="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                                  href="{{ url('my_favorites') }}">俺のお気に入り</a>
                          </li>
                      @endauth
                      ...
                      <li>
                          <a class="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                              href="{{ route('drinks.ranking') }}">ランキング</a>
                      </li>

                      <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                              href="{{ route('drinks.create') }}">何か飲んだから書く?</a></li>
                      <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                              ...
                              target="_blank">注文する?(Amazon)</a></li>
                  </ul>
              </nav>
